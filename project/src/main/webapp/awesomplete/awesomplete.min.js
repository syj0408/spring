...
!function() {
        ...
        this._events = {
            input: {
                ...
                keydown: function(t) {
                    ...
                    s.select()) : 9 === e && s.selected && s.tabSelect ? s.select() : 27 === e ? s.close({
                        reason: "esc"
    ...
    r.prototype = {
        ...
        close: function(t) {
            this.opened && (this.input.setAttribute("aria-expanded", "false"),
        ...
        destroy: function() {
            if (i.unbind(this.input, this._events.input),
        ...
        evaluate: function() {
            var e = this
              , i = this.input.value;
            i.length >= this.minChars && this._list && this._list.length > 0 ? (this.index = -1,
            this.ul.innerHTML = "",
            ...
            this.status.textContent = this.ul.children.length + " results found")) : (this.close({
                reason: "nomatches"
            }),
