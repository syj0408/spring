(function() {
  /*VERSION:180619*/ 'object' != typeof JSON && (JSON = {}),
    (function() {
      'use strict';
      function f(a) {
        return 10 > a ? '0' + a : a;
  ...
  (postcodeUtils.param = (function(a) {
    ...
    (postcodeUtils.isAndroidWebview = function(a) {
      for (var b = ['version/', 'samsungbrowser'], c = !1, d = 0, e = b.length; e > d; d++)
        if (a.indexOf(b[d]) > -1) {
          c = !0;
          break;
        }
        ...
        function o(a) {
          for (var b in q.POPUP_MAP)
            if (q.POPUP_MAP.hasOwnProperty(b))
              for (var c = q.POPUP_MAP[b], d = 0, e = c.length; e > d; d++) if (a === c[d].ref) return c[d];
          return null;
        }
        function p(a) {
          var b =
    ...
    a.frame = (function() {
      function a(a) {
        ...
        var d = q + '&' + f.getStringByOptions(c, '=', '&'),
          ...
          i =
            '<iframe frameborder="0" title="�고렪踰덊샇寃��됲봽�덉엫" id="' +
            ...
            function(a, i) {
              'resize' === a
                ? d.onResize !== g.EMPTY_FUNCTION &&
                  (d.onResize(i), h.adjustLowIE(f, b, c, j.getId('viewerFrame', d.viewerNo), i.width, i.height))
                : 'done' === a &&
  ...
  !(function(a, b, c, d, e) {
    ...
    a.themePreprocessor = (function() {
      ...
      function j(a) {
        ...
        b = a[s.CONTENT_BG];
        var h = k(b);
        return { search: c, suggest: d, selectbox: e, page: f, more: g, layerClose: h };
      }
      function k(a) {
        var b = 1,
          c = 0;
  ...
  !(function(a, b, c, d, e) {
    function f(a, b) {
      ...
      if (b) {
        ...
        d &&
          ...
          (c =
            e === !0
              ? k.extend(a, { region_name: encodeURIComponent(d), cq: encodeURIComponent(d), intsh: 'on' })
              : k.extend(a, { userQuery: encodeURIComponent(d), cq: encodeURIComponent(d) }));
      }
      return c;
    }
    function g(a, b) {
    ...
    function h(a, b) {
      ...
      if (b) {
        var d = b.popupName;
        d && 'string' == typeof d && '' !== k.trim(d) && (c = k.extend(a, { popupName: d }));
      }
      return c;
    }
    function i(a, b) {
      ...
      if (b) {
        var d = b.autoClose;
        void 0 !== d && null !== d && 'boolean' == typeof d && (c = k.extend(a, { autoClose: d }));
      }
      return c;
    }
    function j(a) {
      ...
      (j.prototype = {
        open: function(a) {
          ...
          (b = f(b, a)),
            ...
            (b = h(b, a)),
            (b = i(b, a)),
            (b = k.extend(b, { viewType: 'popup' })),
            o.popup.create(b);
        },
        embed: function(a, b) {
          var c = k.extend({}, this._opt_);
          (c = f(c, b)), (c = i(c, b)), (c = k.extend(c, { viewType: 'layer' })), o.layer.create(c, a);
        },
      }),
      (c.daum.Postcode = j);
  })(v2, postcodeUtils, window, document, location);
