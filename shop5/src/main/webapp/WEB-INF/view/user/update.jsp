...
<!-- "${error.code}" {}괄호사이에서 공백이 있어도되지만 }" 사이에 공백 X -->
<body>
<h2>사용자 정보 수정</h2> 
...
<table>
	...
	<tr><td colspan="2" align="center"><input type="submit" value="수정"><input type="reset" value="초기화"><input type="button" value="비밀번호 변경" onclick="win_passchg()"></td></tr>
</table>
</form:form> 
</body>
</html>