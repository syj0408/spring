                ...
                f.prototype = {
                    ...
                    config: function(a, b) {
                        ...
                        var e = {
                          ...
                          , f = d.autoBreadcrumbs;
                        "[object Object]" === {}.toString.call(f) ? f = l(e, f) : f !== !1 && (f = e),
                        d.autoBreadcrumbs = f;
                        var g = {
                            tryCatch: !0
                        }
                          , h = d.instrument;
                        return "[object Object]" === {}.toString.call(h) ? h = l(g, h) : h !== !1 && (h = g),
                        d.instrument = h,
                    ...
                    R: function(a, b) {
                        ...
                        if (this.b) {
                            ...
                            J.createEvent ? (c = J.createEvent("HTMLEvents"),
                            c.initEvent(a, !0, !0)) : (c = J.createEventObject(),
                            c.eventType = a);
                            for (d in b)
                                o(b, d) && (c[d] = b[d]);
                            if (J.createEvent)
                    ...
                    X: function(a, b, c, d, e, f) {
                        var g;
                        if ((!this.k.ignoreErrors.test || !this.k.ignoreErrors.test(b)) && (b += "",
                        ...
                        for (var b, c, d, e = ["to", "from", "url"], f = 0; f < a.values.length; ++f)
                            ...
                            c.hasOwnProperty("data") && E(c.data) && !m(c.data)) {
                                ...
                                for (var g = 0; g < e.length; ++g)
                                    b = e[g],
                                    d.hasOwnProperty(b) && (d[b] = n(d[b], this.k.maxUrlLength));
                                a.values[f].data = d
                            }
                    },
                    _: function() {
                    ...
                    P: function(a) {
                        ...
                        this.t && this.t.length > 0 && (a.breadcrumbs = {
                    ...
                    fa: function(a, b) {
                        var c = this
                          , d = this.k;
                        if (this.isSetup()) {
                            if (this.f = a.event_id || (a.event_id = this.ga()),
                            a = this.Z(a),
        ...
        7: [function(a, b, c) {
            ...
            function f(a, b) {
                ...
                function(f, g) {
                    if (c.length > 0) {
                        var h = d(c, this);
                        ~h ? c.splice(h + 1) : c.push(this),
                        ~h ? e.splice(h, 1 / 0, f) : e.push(f),
                        ~d(c, g) && (g = b.call(this, f, g))
                    } else
                        c.push(g);
